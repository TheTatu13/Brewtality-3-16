...
- **{{COMPANY_BRAND}} — listing**: `{{CAREER_URL}}` — pagina publică de posturi deschise
- **{{COMPANY_BRAND}} — sitemap**: `{{SITEMAP_URL}}` — permalink-uri canonice
